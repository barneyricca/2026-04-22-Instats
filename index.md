...
venue: "Instats"        # brief name of the institution that hosts the workshop without address (e.g., "Euphoric State University")
...
humandate: "July 21-22, 2026"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "11:00 am - 3:00 pm EST (4:00 pm - 8:00 pm UTC)"    # human-readable times for the workshop e.g., "9:00 am - 4:30 pm CEST (7:00 am - 2:30 pm UTC)"
startdate: 2026-07-21      # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: 2026-07-22        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Jose Nino Muriel", "Barney Ricca"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["TBD"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["jose_nino@ucsb.edu","bricca@ur.rochester.edu"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
...
<p id="accessibility">
  ...
  accessible to everybody. We are dedicated to providing a positive and accessible learning environment for all. 
